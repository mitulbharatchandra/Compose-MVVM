package com.app.myapplication.data.preferences
...
class DefaultPreferences(
    ...
    override fun loadUserInfo(): UserInfo {
        val age = sharedPref.getInt(Preferences.KEY_AGE, 35)
        val height = sharedPref.getInt(Preferences.KEY_HEIGHT, 160)
        val weight = sharedPref.getFloat(Preferences.KEY_WEIGHT, 60f)
        val genderString = sharedPref.getString(Preferences.KEY_GENDER, Gender.Male.name)
        val activityLevelString = sharedPref
            .getString(Preferences.KEY_ACTIVITY_LEVEL, ActivityLevel.High.name)
        val goalType = sharedPref.getString(Preferences.KEY_GOAL_TYPE, GoalType.LoseWeight.name)
